const typed = new Typed(".typed", {
  strings: [
    '<span class="typed_text1">CAMPCON</span><br><span class="typed_text2">Seguridad Industrial y Demarcaciones Viales</span> <br><span class="typed_text3">Compromiso y calidad asegurada...</span>',
  ],
